...
public class ResumenTramite {
  ...
  public ResumenTramite(Long id, LocalDateTime fechaInicio, LocalDateTime fechaTermino,
      Long totalRegistroBase, Long totalRegistroBaseEstimada, Long totalRegistroPortal,
      String tiempo) {
    this.id = id;
