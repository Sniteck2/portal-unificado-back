...
@Entity
@Table(name = "RTO_ESCRITO")
public class ResumenEscrito {
    ...
    public ResumenEscrito() {
    }

    public ResumenEscrito(Long id, LocalDateTime fechaInicio, LocalDateTime fechaTermino, Long totalRegistroBase, Long totalRegistroBaseEstimada, Long totalRegistroPortal, String tiempo) {
        this.id = id;
