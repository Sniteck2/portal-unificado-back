...
@Entity
@Table(name = "RTO_PARTE")
public class ResumenParte {
  ...
  public ResumenParte(Long id, LocalDateTime fechaInicio, LocalDateTime fechaTermino, Long totalRegistroBase, Long totalRegistroBaseEstimada, Long totalRegistroPortal, String tiempo) {
    this.id = id;
