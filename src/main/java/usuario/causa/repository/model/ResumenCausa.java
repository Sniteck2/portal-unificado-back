...
@Entity
@Table(name = "RTO_CAUSA")
public class ResumenCausa {
  ...
  public ResumenCausa(Long id, LocalDateTime fechaInicio, LocalDateTime fechaTermino, Long totalRegistroBase, Long totalRegistroBaseEstimada, Long totalRegistroPortal, String tiempo) {
    this.id = id;
